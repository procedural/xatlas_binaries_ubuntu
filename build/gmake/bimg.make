...
ifeq ($(config),release_x86_64)
  ...
  INCLUDES += -I../../extra/thirdparty/bx/include -I../../extra/thirdparty/bimg/include
  FORCE_INCLUDE +=
...
$(OBJDIR)/image.o: ../../extra/thirdparty/bimg/src/image.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/image_gnf.o: ../../extra/thirdparty/bimg/src/image_gnf.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
